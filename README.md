...
Built for a hackathon, on the shoulders of [Manim Community](https://www.manim.community/), [ElevenLabs](https://elevenlabs.io/), [FastAPI](https://fastapi.tiangolo.com/), and [Next.js](https://nextjs.org/). Scope and sprint plan in `docs/plan.md`; assignment feature notes in `docs/2026-08-15-assignment-feature.md`.
